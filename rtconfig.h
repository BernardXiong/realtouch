...
// <bool name="RT_USING_DFS_MNTTABLE" description="Using mount table to auto mount" default="true" />
...
// <bool name="RT_USING_WIFI" description="Enable WLAN driver" default="true" />
